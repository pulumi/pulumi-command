...
public class Command extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="archive", type=Archive.class, parameters={})
     ...
     * 
     */
    @Export(name="archivePaths", type=List.class, parameters={String.class})
     ...
     * 
     */
    @Export(name="assetPaths", type=List.class, parameters={String.class})
     ...
     * 
     */
    @Export(name="assets", type=Map.class, parameters={String.class, AssetOrArchive.class})
     ...
     * 
     */
    @Export(name="interpreter", type=List.class, parameters={String.class})
