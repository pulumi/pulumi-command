...
public final class RunArgs extends com.pulumi.resources.InvokeArgs {

    public static final RunArgs Empty = new RunArgs();
    ...
    public static Builder builder(RunArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RunArgs defaults) {
            $ = new RunArgs(Objects.requireNonNull(defaults));
        }
