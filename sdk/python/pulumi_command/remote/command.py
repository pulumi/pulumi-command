...
class CommandArgs:
    def __init__(__self__, *,
                 ...
                 logging: Optional[pulumi.Input['local.Logging']] = None,
        ...
        :param pulumi.Input['local.Logging'] logging: If the command's stdout and stderr should be logged. This doesn't affect the capturing of
    ...
    @property
    @pulumi.getter
    def logging(self) -> Optional[pulumi.Input['local.Logging']]:
        """
    ...
    @logging.setter
    def logging(self, value: Optional[pulumi.Input['local.Logging']]):
...
class Command(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def logging(self) -> pulumi.Output[Optional['local.Logging']]:
        """
        If the command's stdout and stderr should be logged. This doesn't affect the capturing of
        stdout and stderr as outputs. If there might be secrets in the output, you can disable logging here and mark the
        outputs as secret via 'additionalSecretOutputs'. Defaults to logging both stdout and stderr.
