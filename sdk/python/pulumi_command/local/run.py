...
class RunResult:
    ...
    def add_previous_output_in_env(self) -> Optional[bool]:
        """
...
def run(add_previous_output_in_env: Optional[bool] = None,
    ...
    :param bool add_previous_output_in_env: If the previous command's stdout and stderr (as generated by the prior create/update) is
           injected into the environment of the next run as PULUMI_COMMAND_STDOUT and PULUMI_COMMAND_STDERR.
           Defaults to true.
